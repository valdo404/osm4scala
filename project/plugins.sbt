...
// addSbtPlugin("org.xerial.sbt" % "sbt-sonatype" % "3.9.7") // Removed
// addSbtPlugin("com.github.sbt" % "sbt-pgp" % "2.1.2") // Removed
...
// For publishing to GitHub Releases (Removed - Handled by GitHub Actions)
